...
const HelpEntry kHelp[] = {
    ...
    { "fore_type", "The near source: a fifth slot of its own, rendered only by the near events. Any of the source types, with the near ones made for it -- Flute, Murmur, Bowl, Ice, Drops, and Clip, which plays a recording straight through once. The clip types (Clip, Texture, Stretch, Spectral) read the near source's own clip -- the one a near preset names from the library's archive, or the one opened with the button -- and Source 4's where it has none." },
    ...
    { "fore_approach", "The share of the event spent arriving out of the far plane and, at the end, leaving into it. A sequence at 0.25 spends its first quarter as a pulse on the horizon and its last quarter dissolving back into it." },
