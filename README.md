...
installs the standalone, the VST3 and the preset library, and offers to download the 100 GB sample
library (the samples, wavetables, rooms and the archive of recordings the presets name). Nothing else has to be installed: the runtime is linked in.
