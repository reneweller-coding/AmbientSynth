...
**[AmbientSynth-1.6.0-Setup.exe](https://github.com/reneweller-coding/AmbientSynth/releases/download/v1.6.0/AmbientSynth-1.6.0-Setup.exe)**
...
the runtime is linked in. **[Portable zip](https://github.com/reneweller-coding/AmbientSynth/releases/download/v1.6.0/AmbientSynth-1.6.0-portable.zip)**
(15 MB) for anyone who would rather not run an installer, and the
**[manual](https://github.com/reneweller-coding/AmbientSynth/releases/download/v1.6.0/AmbientSynth-Manual.pdf)**
