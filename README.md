...
**[AmbientSynth-1.12.1-Setup.exe](https://github.com/reneweller-coding/AmbientSynth/releases/download/v1.12.1/AmbientSynth-1.12.1-Setup.exe)**
...
**[Portable zip](https://github.com/reneweller-coding/AmbientSynth/releases/download/v1.12.1/AmbientSynth-1.12.1-portable.zip)**
for anyone who would rather not run an installer, and the
**[manual](https://github.com/reneweller-coding/AmbientSynth/releases/download/v1.12.1/AmbientSynth-Manual.pdf)**
