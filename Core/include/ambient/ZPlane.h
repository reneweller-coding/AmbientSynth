...
// Ninety-seven shapes, generated by Tools/make_zplane_bank.py, which is where the ratios and the
// acoustics behind each one are written down. The first sixteen are the original hand-written
// bank, carried over frequency for frequency: the library's 5000 presets name their shape as
// text ("z_shape=Glass"), so those names and their order are frozen. New shapes are appended.
